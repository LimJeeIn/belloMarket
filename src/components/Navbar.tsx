...
import UserIcons, { UserIconsProps } from './UserIcons';
...
`;
interface CustomUserIconsProps extends UserIconsProps {
  onClick?: () => void;
}

const CustomUserIcons = styled(UserIcons)<CustomUserIconsProps>`
  display: flex;
  justify-content: space-between;
`;
